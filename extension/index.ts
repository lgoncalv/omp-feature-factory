  ...
  pi.registerCommand("build-feature", {
    ...
    handler: async (args, ctx) => {
      ...
      const kickoffPrompt = [
        ...
        `5. **APPROVAL GATE: Present the milestone URL to the user.**`,
        `   - Show the milestone URL and a summary of the PRD`,
        `   - Ask the user to review and explicitly approve before proceeding`,
        `   - Say: "PRD created at <milestone-url>. Please review and reply 'continue' to proceed with code scout, or describe what changes are needed."`,
        `   - If the user requests changes:`,
        `     a. Use \`gh api -X PATCH repos/:owner/:repo/milestones/:number -f title=... -f description=...\` to update the milestone description`,
        `     b. Re-present the updated milestone URL for approval`,
        `     c. Limit iteration to 3 cycles, then escalate`,
        ...
        ``,
        `5. **APPROVAL GATE: Present the list of created issues to the user.**`,
        `   - Show all issue numbers, titles, and URLs`,
        `   - Include the dependency information between issues`,
        `   - Ask the user to review and explicitly approve before proceeding`,
        `   - Say: "Issues created: #N (title), #M (title), ... Review and reply 'continue' to proceed with parallel implementation, or describe what changes you'd like."`,
        `   - If the user requests changes:`,
        `     a. For issues to be removed: use \`gh issue close <issue-number>\` then \`gh issue reopen\` or recreate as needed`,
        `     b. For issues to be modified: use \`gh issue edit <issue-number> --title "..." --body "..."`,
        `     c. For new issues needed: use \`github_issue_create\` with milestone=1 and appropriate dependsOn`,
        `     d. Re-present the updated list for approval`,
        `     e. Limit iteration to 3 cycles, then escalate`,
